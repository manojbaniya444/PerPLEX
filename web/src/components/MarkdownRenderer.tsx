    ...
    <div className={`prose prose-sm max-w-none ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          h1: ({ ...props }) => (
            <h1 className="text-xl font-bold text-gray-900 mb-3 border-b border-amber-200 pb-2" {...props} />
          ),
          h2: ({ ...props }) => (
          ...
          // Style blockquotes
          blockquote: ({ ...props }) => (
            <blockquote className="border-l-4 border-amber-300 pl-4 py-2 my-3 bg-amber-50 text-gray-700 italic" {...props} />
          ),
          ...
          // Style pre blocks
          pre: ({ ...props }) => (
            <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto mb-3" {...props} />
          ),
          ...
          th: ({ ...props }) => (
            <th className="bg-amber-50 text-gray-800 font-semibold px-4 py-2 border border-gray-200 text-left" {...props} />
          ),
          td: ({ ...props }) => (
            <td className="text-gray-700 px-4 py-2 border border-gray-200" {...props} />
          ),
